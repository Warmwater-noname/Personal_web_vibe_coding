      ...
      <div className="bento-container">
        ...
        <div className="bento-item bento-social" style={{ '--delay': '0.15s' } as React.CSSProperties}>
          <div className="glass-card h-full flex items-center justify-center gap-4" style={{ padding: '0 24px' }}>
            <a href="https://github.com/Warmwater-noname" className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-white transition-colors" style={{ backgroundColor: 'var(--color-primary)' }}>
            ...
            <a href="https://space.bilibili.com/182782785/dynamic" className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium text-white transition-colors" style={{ backgroundColor: '#00a1d6' }}>
              <span className="font-bold text-xs">B</span>
              Bilibili
            </a>
            <a href="3156896114@qq.com" className="flex items-center justify-center w-9 h-9 rounded-xl text-white transition-colors" style={{ backgroundColor: 'var(--color-brand)' }}>
